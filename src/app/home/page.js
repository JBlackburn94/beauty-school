  ...
  return (
    <main className='flex flex-col items-center justify-center mt-8 font-semibold text-white uppercase md:flex-row md:justify-evenly'>
      <Image 
        ...
        className="w-1/2 h-auto md:w-1/3 drop-shadow-2xl animate-fade animate-once animate-duration-[2000ms]"
      />
      <div className='flex flex-col items-center justify-center'>
        <Image 
          src={Logo}
          alt='Beauty School Logo'
          className='w-1/2 h-auto my-2 md:w-4/5 drop-shadow-2xl animate-fade animate-once animate-duration-[2000ms] animaion-delay-1000'
        />
        <p className='my-2 text-2xl font-bold animate-fade animate-once animate-duration-[2000ms] animaion-delay-2000'>Happiness</p>
        <div className='flex flex-col my-2 md:flex-row animate-fade animate-once animate-duration-[2000ms] animaion-delay-3000'>
        ...
        <Image 
          ...
          className='w-20 cursor-pointer md:w-40 animate-fade animate-once animate-duration-[2000ms] animaion-delay-4000'
        />
      </div>
    </main>
  )
